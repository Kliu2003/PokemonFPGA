...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Pokemon_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Pokemon_soc
SOPC_NAME := Pokemon_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2a0
SOPC_SYSID_FLAG += --sidp=0x2a0
ELF_PATCH_FLAG  += --sidp 0x2a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1670556264
SOPC_SYSID_FLAG += --timestamp=1670556264
ELF_PATCH_FLAG  += --timestamp 1670556264
